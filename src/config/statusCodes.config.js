...
module.exports = {
    ...
    [GET_EVALUATIONS_BY_ET_MEMBER_USER_DNE_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [GET_EVALUATIONS_BY_ET_MEMBER_NOT_PART_OF_ANY_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
