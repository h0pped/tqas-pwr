...
module.exports = {
    ...
    [PROTOCOL_FILLED_SUCCESSFULLY]: StatusCodes.OK,
    [FILL_PROTOCOL_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [EXPORT_ID_REQUIRED_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [EXPORT_DNE_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [EXPORT_MUST_BE_APPROVED_FIRST_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [EXPORT_ERROR_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
    [EXPORT_ASSESSMENT_SCHEDULE_SUCCESS]: StatusCodes.OK,
    [DRAFT_PROTOCOL_SAVED]: StatusCodes.OK,
    [DRAFT_PROTOCOL_BAD_REQUEST]: StatusCodes.BAD_REQUEST,
}
